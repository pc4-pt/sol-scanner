import { j as PublicKey } from "./index.browser.esm-Btz9lHmd.js";
import { _ as WalletPublicKeyError, a as WalletReadyState, b as WalletSignMessageError, d as WalletDisconnectedError, f as WalletDisconnectionError, g as WalletNotReadyError, h as WalletNotConnectedError, l as WalletConfigError, m as WalletLoadError, o as isIosAndRedirectable, p as WalletError, r as isVersionedTransaction, s as scopePollingDetectionStrategy, t as BaseMessageSignerWalletAdapter, u as WalletConnectionError, v as WalletSendTransactionError, x as WalletSignTransactionError } from "./signer-xW9y32jc.js";
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let SolflareClass;
			try {
				SolflareClass = (await import("./esm-DpxCupg1.js")).default;
			} catch (error) {
...
//#endregion
export { SolflareWalletAdapter, SolflareWalletName };
