...
*/
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
var _0n$2 = /* @__PURE__ */ BigInt(0), _1n$2 = BigInt(1), _2n$3 = BigInt(2), _3n$1 = BigInt(3);
...
var ELL2_C2 = Fp.pow(_2n$3, ELL2_C1);
...
var Secp256k1Program = class Secp256k1Program {
	...
	*/
	static publicKeyToEthAddress(publicKey) {
		...
		try {
			return import_buffer.Buffer.from(keccak_256(toBuffer(publicKey))).slice(-ETHEREUM_ADDRESS_BYTES);
		} catch (error) {
...
//#endregion
export { Struct as $, PUBLIC_KEY_LENGTH as A, SYSVAR_RECENT_BLOCKHASHES_PUBKEY as B, MAX_SEED_LENGTH as C, eventemitter3_default as Ct, NONCE_ACCOUNT_LENGTH as D, MessageV0 as E, STAKE_INSTRUCTION_LAYOUTS as F, SYSVAR_STAKE_HISTORY_PUBKEY as G, SYSVAR_REWARDS_PUBKEY as H, SYSTEM_INSTRUCTION_LAYOUTS as I, SolanaJSONRPCError as J, Secp256k1Program as K, SYSVAR_CLOCK_PUBKEY as L, SIGNATURE_LENGTH_IN_BYTES as M, SOLANA_SCHEMA as N, NonceAccount as O, STAKE_CONFIG_ID as P, StakeProgram as Q, SYSVAR_EPOCH_SCHEDULE_PUBKEY as R, Lockup as S, sendAndConfirmTransaction as St, MessageAccountKeys as T, SYSVAR_SLOT_HASHES_PUBKEY as U, SYSVAR_RENT_PUBKEY as V, SYSVAR_SLOT_HISTORY_PUBKEY as W, StakeAuthorizationLayout as X, SolanaJSONRPCErrorCode as Y, StakeInstruction as Z, FeeCalculatorLayout as _, VoteInit as _t, Authorized as a, TransactionExpiredTimeoutError as at, LOOKUP_TABLE_INSTRUCTION_LAYOUTS as b, clusterApiUrl as bt, BPF_LOADER_PROGRAM_ID as c, TransactionStatus as ct, ComputeBudgetInstruction as d, VOTE_PROGRAM_ID as dt, SystemInstruction as et, ComputeBudgetProgram as f, ValidatorInfo as ft, EpochSchedule as g, VoteAuthorizationLayout as gt, Enum as h, VoteAccount as ht, AddressLookupTableProgram as i, TransactionExpiredNonceInvalidError as it, PublicKey as j, PACKET_DATA_SIZE as k, BpfLoader as l, VALIDATOR_INFO_KEY as lt, Ed25519Program as m, VersionedTransaction as mt, AddressLookupTableAccount as n, Transaction as nt, BLOCKHASH_CACHE_TIMEOUT_MS as o, TransactionInstruction as ot, Connection as p, VersionedMessage as pt, SendTransactionError as q, AddressLookupTableInstruction as r, TransactionExpiredBlockheightExceededError as rt, BPF_LOADER_DEPRECATED_PROGRAM_ID as s, TransactionMessage as st, Account as t, SystemProgram as tt, COMPUTE_BUDGET_INSTRUCTION_LAYOUTS as u, VERSION_PREFIX_MASK as ut, Keypair as v, VoteInstruction as vt, Message as w, Loader as x, sendAndConfirmRawTransaction as xt, LAMPORTS_PER_SOL as y, VoteProgram as yt, SYSVAR_INSTRUCTIONS_PUBKEY as z };

//# sourceMappingURL=index.browser.esm-Btz9lHmd.js.map